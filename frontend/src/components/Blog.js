...
const Blog = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const res = await axios.get(`${process.env.REACT_APP_API_URL}/api/portfolio_app/featured`);
    ...
    useEffect(() => {
        const fetchBlogs = async () => {
            try {
                const res = await axios.get(`${process.env.REACT_APP_API_URL}/api/portfolio_app/`);
                setBlogs(res.data);
            }
            catch (err) {
        ...
        <div className='container mt-3'>
            ...
            <div className="p-4 p-md-5 mb-4 text-white rounded bg-dark">
                <div className="col-md-6 px-0">
                    ...
                    <p className="lead mb-0"><Link to={`/blog/${featuredBlog.slug}`}
